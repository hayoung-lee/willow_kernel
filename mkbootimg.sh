...
cp drivers/net/wireless/bcmdhd/bcmdhd.ko ../willow_jb_android_sw1/out/target/product/willow/system/lib/modules/
cp drivers/net/wireless/bcmdhd/bcmdhd.ko ../willow_jb_android_sw1/device/thinkware/willow/
